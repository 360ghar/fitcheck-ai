...
export type AdminUserBilling = components['schemas']['AdminUserBilling']
export type AdminUserBodyProfile = components['schemas']['AdminUserBodyProfile']
export type AdminUserDetail = components['schemas']['AdminUserDetail']
export type AdminUserGeneration = components['schemas']['AdminUserGeneration']
export type AdminUserGenerationsPage = components['schemas']['AdminUserGenerationsPage']
...
export type AdminUserReferrals = components['schemas']['AdminUserReferrals']
