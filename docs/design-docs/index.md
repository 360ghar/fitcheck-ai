...
Catalog of design and decision documents. Verification status helps agents know what to trust.

| Doc | Status | Last reviewed | Notes |
|-----|--------|---------------|-------|
...
- **verified** — matches current code and process; safe for agents to follow  
- **draft** — useful but incomplete or partially aspirational  
- **stale** — known drift; do not treat as ground truth without checking code  

When you confirm or fix a doc, update its status and date here.
