...
_$BatchImageImpl _$$BatchImageImplFromJson(Map<String, dynamic> json) =>
    _$BatchImageImpl(
      id: json['id'] as String,
      filePath: json['filePath'] as String,
      base64Data: json['base64Data'] as String?,
      thumbnailPath: json['thumbnailPath'] as String?,
      status: $enumDecodeNullable(_$BatchImageStatusEnumMap, json['status']) ??
          BatchImageStatus.pending,
      error: json['error'] as String?,
      extractedItems: (json['extractedItems'] as List<dynamic>?)
              ?.map(
                  (e) => BatchExtractedItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );

Map<String, dynamic> _$$BatchImageImplToJson(_$BatchImageImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_$BatchExtractionJobImpl _$$BatchExtractionJobImplFromJson(
        Map<String, dynamic> json) =>
    _$BatchExtractionJobImpl(
...
Map<String, dynamic> _$$BatchExtractionJobImplToJson(
        _$BatchExtractionJobImpl instance) =>
    <String, dynamic>{
...
_$BatchExtractedItemImpl _$$BatchExtractedItemImplFromJson(
        Map<String, dynamic> json) =>
    _$BatchExtractedItemImpl(
      id: json['id'] as String,
      ...
      status: $enumDecodeNullable(_$BatchItemStatusEnumMap, json['status']) ??
          BatchItemStatus.pending,
      isSelected: json['isSelected'] as bool? ?? true,
      error: json['error'] as String?,
    );

Map<String, dynamic> _$$BatchExtractedItemImplToJson(
        _$BatchExtractedItemImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_$BatchExtractionRequestImpl _$$BatchExtractionRequestImplFromJson(
        Map<String, dynamic> json) =>
    _$BatchExtractionRequestImpl(
      ...
      generationBatchSize:
          (json['generation_batch_size'] as num?)?.toInt() ?? 5,
    );

Map<String, dynamic> _$$BatchExtractionRequestImplToJson(
        _$BatchExtractionRequestImpl instance) =>
    <String, dynamic>{
...
_$BatchImageInputImpl _$$BatchImageInputImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$BatchImageInputImplToJson(
        _$BatchImageInputImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'image_base64': instance.imageBase64,
    };

_$BatchExtractionResponseImpl _$$BatchExtractionResponseImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$BatchExtractionResponseImplToJson(
        _$BatchExtractionResponseImpl instance) =>
    <String, dynamic>{
...
_$BatchJobStatusResponseImpl _$$BatchJobStatusResponseImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$BatchJobStatusResponseImplToJson(
        _$BatchJobStatusResponseImpl instance) =>
    <String, dynamic>{
      'job_id': instance.jobId,
      'status': instance.status,
      'total_images': instance.totalImages,
