...
class BodyProfilesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Body Profiles'), elevation: 0),
                  ...
                  children: [
                    ...
                    if (controller.profiles.isEmpty)
                      ...
                      ...controller.profiles.map(
                        (profile) =>
                            _buildProfileCard(context, profile, controller),
                      ),
                  ],
                ),
              ),
  ...
  Widget _buildInfoCard(BuildContext context, AppUiTokens tokens) {
    return AppGlassCard(
      ...
      child: Row(
        children: [
          Icon(Icons.info_outline, color: tokens.brandColor),
  ...
  Widget _buildEmptyState(BuildContext context, AppUiTokens tokens) {
    return AppGlassCard(
      ...
      child: Center(
        child: Column(
          children: [
            Icon(Icons.accessibility_new, size: 48, color: tokens.textMuted),
