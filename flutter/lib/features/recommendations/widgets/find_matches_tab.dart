...
class FindMatchesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      key: const PageStorageKey('find_matches_tab'),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                TextField(
                  onChanged: (value) =>
                      controller.matchesSearchQuery.value = value,
                ...
                Obx(
                  () => DropdownButtonFormField<String>(
                    initialValue: controller.matchesCategoryFilter.value,
                    isExpanded: true,
                    itemHeight: null,
                    decoration: const InputDecoration(labelText: 'Category'),
                    onChanged: (value) {
                      if (value != null) {
                        controller.matchesCategoryFilter.value = value;
                      }
                    },
                    items: [
            ...
            if (controller.selectedItems.isEmpty) {
              return Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.touch_app, size: 64, color: tokens.textMuted),
                    const SizedBox(height: AppConstants.spacing16),
                    Text(
