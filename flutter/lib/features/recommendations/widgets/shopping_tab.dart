...
class ShoppingTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      key: const PageStorageKey('shopping_tab'),
                  ...
                  children: [
                    Obx(
                      () => DropdownButtonFormField<String>(
                        ...
                        onChanged: (value) {
                          if (value != null) {
                            controller.shoppingCategory.value = value;
                          }
                        },
                      ),
                    ),
                    ...
                    Obx(
                      () => DropdownButtonFormField<String>(
                        ...
                        onChanged: (value) {
                          if (value != null) {
                            controller.shoppingStyle.value = value;
                          }
                        },
                      ),
                    ),
                  ...
                  () => Column(
                    ...
                    children: [
                      ...
                      Slider(
                        ...
                        onChanged: (value) =>
                            controller.shoppingBudget.value = value,
                      ),
                    ],
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: Obx(
                    () => ElevatedButton.icon(
                      ...
                      label: Text(
                        controller.isLoadingShopping.value
                            ? 'Searching...'
                            : 'Get Recommendations',
                      ),
