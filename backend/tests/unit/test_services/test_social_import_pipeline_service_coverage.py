...
# Helpers moved to tests/utils/social_import_helpers.py (shared with
# test_social_import_pipeline_flows.py) so the fakes cannot diverge.
from tests.utils.social_import_helpers import (  # noqa: F401 (re-exported for this file's tests)
    _async_value,
    _identity_photo,
    _noop_async,
