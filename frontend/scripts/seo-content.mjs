...
export const SEO_ROUTES = [
  ...
  { path: '/faq', title: 'FAQ | FitCheck AI Virtual Closet & Outfit Planner', description: 'Answers about AI wardrobe extraction, virtual try-on, photoshoots, pricing, privacy, and how FitCheck AI organizes your clothes.', priority: '0.8', changefreq: 'monthly', keyPoints: ['Free plan: 50 extractions/month, 50 visualizations/month, 10 photoshoot images/day.', 'Plus ($10/month or $100/year): 200 extractions, 350 visualizations, 30 photoshoot images/day.', 'Pro ($20/month or $200/year): 400 extractions, 1,000 visualizations, 50 photoshoot images/day.', 'Wardrobe data is private by default and not sold to third parties.'] },
  ...
  { path: '/compare/fitcheck-vs-acloset', title: 'FitCheck AI vs Acloset | Virtual Closet Comparison', description: 'Side-by-side comparison of FitCheck AI and Acloset: wardrobe extraction, try-on, recommendations, pricing, and who each app is for.', priority: '0.85', changefreq: 'monthly', keyPoints: ['Acloset is a digital wardrobe app centered on cataloging and organization.', 'FitCheck AI auto-catalogs clothes from photos with AI and adds virtual try-on, outfit recommendations, AI photoshoots, and analytics.', 'Both have free tiers — compare digitization speed and daily outfit help before committing a full closet.'] },
  { path: '/compare/fitcheck-vs-whering', title: 'FitCheck AI vs Whering | Digital Wardrobe Comparison', description: 'Compare FitCheck AI and Whering for digital wardrobes, outfit planning, analytics, and AI features.', priority: '0.85', changefreq: 'monthly', keyPoints: ['Whering focuses on cataloging your wardrobe and supporting sustainable fashion choices.', 'FitCheck AI adds AI photo extraction, generative try-on, AI photoshoots, and weather/calendar-aware recommendations.', 'Choose based on what you want after cataloging: organization and sustainability tracking vs AI-assisted daily outfits.'] },
