    ...
    <>
      ...
      <div className="pt-20">
        <LandingFeatureSection
          badge={{ icon: BarChart3, text: 'Data-Driven Fashion' }}
          title="Wardrobe Analytics"
          subtitle="Understand Your Closet Like Never Before"
          description="Track cost-per-wear, analyze usage patterns, and get actionable insights to build a smarter, more valuable wardrobe. Turn your closet into a data-driven investment."
          accentColor="blue"
          primaryCta={{ text: 'Analyze My Wardrobe', to: '/auth/register' }}
          secondaryCta={{ text: 'Learn How It Works', to: '#how-it-works' }}
        />
        ...
        <BenefitGrid
          items={features}
          heading="Powerful Wardrobe Insights"
          subheading="Comprehensive analytics to help you understand, optimize, and improve your wardrobe"
          accentColor="blue"
          background="stone"
        />
        ...
        {/* CTA Section */}
        <CtaBand
          heading="Turn your closet into a data-driven investment"
          subtext="Join thousands using wardrobe analytics to shop smarter, save money, and build a more valuable closet."
          primaryCta={{ text: 'Start Tracking Analytics', to: '/auth/register' }}
          footnote="Free plan includes full analytics dashboard. No credit card required."
          accentColor="blue"
        />
      </div>
    </>
