...
export const STATIC_PUBLIC_ROUTES: Array<{
  ...
  { path: '/compare/fitcheck-vs-stylebook', title: 'FitCheck AI vs Stylebook | Digital Closet Comparison', description: 'Compare FitCheck AI and Stylebook for digital wardrobes: manual cataloging vs AI extraction, try-on, outfit planning, and pricing.', priority: 0.85, changefreq: 'monthly' },
  { path: '/compare/fitcheck-vs-indyx', title: 'FitCheck AI vs Indyx | Wardrobe App Comparison', description: 'Compare FitCheck AI and Indyx: AI wardrobe cataloging, stylist services, try-on, analytics, and who each app suits.', priority: 0.85, changefreq: 'monthly' },
  { path: '/compare/fitcheck-vs-cladwell', title: 'FitCheck AI vs Cladwell | AI Wardrobe & Outfit Comparison', description: 'Compare FitCheck AI and Cladwell: daily outfit math, wardrobe utilization, try-on, and AI generation.', priority: 0.85, changefreq: 'monthly' },
  { path: '/compare/fitcheck-vs-open-wardrobe', title: 'FitCheck AI vs Open Wardrobe | Virtual Closet Comparison', description: 'Compare FitCheck AI and Open Wardrobe: open-source cataloging vs AI extraction, try-on, and outfit recommendations.', priority: 0.85, changefreq: 'monthly' },
  { path: '/guides/what-is-a-capsule-wardrobe', title: 'What Is a Capsule Wardrobe? Definition, Checklist & Apps | FitCheck AI', description: 'A capsule wardrobe definition, how to build one from clothes you own, checklists, and which apps help.', priority: 0.8, changefreq: 'monthly' },
  { path: '/guides/what-is-wardrobe-utilization', title: 'Wardrobe Utilization: What It Is and How to Measure It | FitCheck AI', description: 'Wardrobe utilization explained — the share of your closet you actually wear — plus how to measure and improve it.', priority: 0.8, changefreq: 'monthly' },
  { path: '/tools/cost-per-wear-calculator', title: 'Cost Per Wear Calculator — Free & Instant | FitCheck AI', description: 'Calculate the true cost per wear of any clothing item in seconds. Free tool with wardrobe analytics tips.', priority: 0.8, changefreq: 'monthly' },
  // City wear pages ("what to wear in <city>")
  { path: '/wear/what-to-wear-in-mumbai', title: 'What to Wear in Mumbai: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Mumbai all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-delhi', title: 'What to Wear in Delhi: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Delhi all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-bengaluru', title: 'What to Wear in Bengaluru: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Bengaluru all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-chennai', title: 'What to Wear in Chennai: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Chennai all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-london', title: 'What to Wear in London: Season-by-Season Guide | FitCheck AI', description: 'What to wear in London all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-new-york', title: 'What to Wear in New York: Season-by-Season Guide | FitCheck AI', description: 'What to wear in New York all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-dubai', title: 'What to Wear in Dubai: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Dubai all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-singapore', title: 'What to Wear in Singapore: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Singapore all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-toronto', title: 'What to Wear in Toronto: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Toronto all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
  { path: '/wear/what-to-wear-in-sydney', title: 'What to Wear in Sydney: Season-by-Season Guide | FitCheck AI', description: 'What to wear in Sydney all year: season-by-season outfit formulas, weather notes, and packing tips — built on clothes you already own.', priority: 0.7, changefreq: 'monthly' },
]
